...
public class ProductList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// ajout
		produitD.create(new ProduitM(getServletInfo(), getServletName(), serialVersionUID, getServletInfo(), null, 0, 0))
		
		request.getParameter("intputTitre"), request.getParameter("inputDescr"), request.getParameter("inputPrix"), request.getParameter(""), request.getParameter(""), 
